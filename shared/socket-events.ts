...
export interface ServerToClientEvents {
 worldClock:(serverNow:number)=>void; portalPositionsUpdated:(positions:PortalPosition[])=>void; interactionPositionsUpdated:(positions:WorldInteractionPosition[])=>void; currentMapUsers:(players:PlayerState[])=>void; userJoined:(player:PlayerState)=>void; userMoved:(player:PlayerState)=>void; userLeft:(id:string)=>void; onlineUsersUpdated:(players:PlayerState[])=>void;
...
export interface ClientToServerEvents {
 joinMap:(payload:JoinMapPayload)=>void; changeMap:(payload:JoinMapPayload)=>void; userMoved:(payload:MovementPayload)=>void; savePortalPosition:(position:PortalPosition)=>void; saveInteractionPosition:(position:WorldInteractionPosition)=>void; sendNearbyChat:(message:string)=>void;
