import {BEAR_FEED_SPOT_IDS,GARDEN_FLOWER_IDS,FARM_REWARD_IDS,type BearFeedId,type BearFeedSpotId,type GardenFlowerId,type PersonalFarmProgressDto} from '../../shared/personal-farm';
...
export class MemoryProgressRepository implements ProgressRepository {
  ...
  plantFlower(id:GardenFlowerId){return this.update(progress=>{if(!progress.gardenMission.plantedFlowerIds.includes(id))progress.gardenMission.plantedFlowerIds.push(id);});}
