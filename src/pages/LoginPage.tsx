    ...
    <section className="login-design-card">
      ...
      <div className="login-design-content">
        <section className="login-design-intro">
          ...
          <h1>AI와 함께<br/><em>새로운 세종</em>을 만나요.</h1>
          <p>다른 사용자와 협력하고 충녕이의 안내를 따라<br/>세종의 다양한 공간을 함께 체험해보세요.</p>
          <div className="login-design-scene" aria-hidden="true">
            ...
            <span className="login-design-bubble"><MapPin size={14} fill="currentColor"/> 세종호수공원에서 만나요!</span>
          </div>
