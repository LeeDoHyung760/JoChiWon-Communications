...
export const defaultProfile:UserProfile={nickname:'',mbti:'',interests:[],usagePurposes:[],preferredPlaceCategories:[],recordVisibility:'public',chatEnabled:true,model:'girl1',character:{hair:'hair-original',face:'face-original',top:'top-original',topLayer:'top-layer-original',bottom:'bottom-original',shoes:'shoes-original',accessory:'accessory-none'}};
