...
export interface CharacterParts{hair:string;hairStyle?:'hair1'|'hair2'|'both';face:string;top:string;topLayer?:string;bottom:string;shoes:string;accessory?:string}
