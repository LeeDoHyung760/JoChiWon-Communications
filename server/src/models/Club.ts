...
const memberSchema=new Schema({userId:{type:String,required:true},name:{type:String,required:true},joinedAt:{type:String,required:true},role:{type:String,enum:['chair','executive','member'],default:'member'}},{_id:false});
